...
- **Backend:** `/home/runner/work/Facttrack/Facttrack/app` as a FastAPI application served with Uvicorn.
- **Frontend:** `/home/runner/work/Facttrack/Facttrack/frontend` as a Vite production bundle emitted to `frontend/dist/`.
...
Copy `/home/runner/work/Facttrack/Facttrack/.env.example` to `/home/runner/work/Facttrack/Facttrack/.env` and adjust values for your environment.
...
Copy `/home/runner/work/Facttrack/Facttrack/frontend/.env.example` to `/home/runner/work/Facttrack/Facttrack/frontend/.env`.

- **Development:** leave `VITE_API_BASE_URL` empty and set `VITE_API_PROXY_TARGET` to the backend origin.
- **Production build:** use `/home/runner/work/Facttrack/Facttrack/frontend/.env.production.example` and set `VITE_API_BASE_URL` to the deployed API origin. `VITE_API_PROXY_TARGET` is only used by the Vite dev server.
...
1. **Install dependencies**
   ...
   ```bash
   cd /home/runner/work/Facttrack/Facttrack
   make install
   ```
...
2. **Create environment files**
   ...
   ```bash
   cp /home/runner/work/Facttrack/Facttrack/.env.example /home/runner/work/Facttrack/Facttrack/.env
   cp /home/runner/work/Facttrack/Facttrack/frontend/.env.example /home/runner/work/Facttrack/Facttrack/frontend/.env
   ```
...
GitHub Actions now enforces the same contract remotely through `/home/runner/work/Facttrack/Facttrack/.github/workflows/build.yml`:
...
- **`make backend-validate` fails during import:** verify that `/home/runner/work/Facttrack/Facttrack/.env` exists and that required Python dependencies are installed.
